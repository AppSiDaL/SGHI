...
router.post("/", middleware.userExtractor, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dias = Math.floor((fecha_salida.getTime() - fecha.getTime()) / (1000 * 60 * 60 * 24));
    const newOrden = Object.assign(Object.assign({}, req.body), { mano_obra: req.body.manoObra, dias: dias });
